...
```bash
git remote add encore encore://speak-legal-app-q2yi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/speak-legal-app-q2yi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/speak-legal-app-q2yi/settings/integrations/github)
