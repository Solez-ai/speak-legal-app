// Code generated by the Encore 1.48.6 client generator. DO NOT EDIT.
...
export namespace legal {
    ...
    export class ServiceClient {
         ...
         */
        public async analyze(params: RequestType<typeof api_legal_analyze_analyze>): Promise<ResponseType<typeof api_legal_analyze_analyze>> {
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "-Generated-TS-Client (Encore/1.48.6)";
        }
